...
[![Cases](https://img.shields.io/badge/verified_cases-3-d8ff3e?style=flat-square&labelColor=0a0b09)](./CATALOG.md)
...
| [`data/cases.json`](./data/cases.json) | Verified, structured MiniMax H3 video prompts and metadata |
