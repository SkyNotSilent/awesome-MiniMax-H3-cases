...
<!-- build-metrics:start -->
**Reference build (Node 22.23.1, analytics configuration omitted):** 109.7 kB homepage JavaScript gzip · 9.7 kB / 9.4 kB Chinese / English homepage HTML gzip · 5.8 kB first-page API gzip · 4.2 kB next-page API gzip · 5.8 kB search response gzip · 51.3 kB local fonts (nonblocking) · 1561.3 kB server-only index gzip. Run `npm run performance:budget` for static budgets and `npm run performance:browser` against a local production server for browser behavior.
<!-- build-metrics:end -->
