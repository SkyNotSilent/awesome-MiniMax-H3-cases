...
### 868 个来源可追溯、可站内观看的视频案例 · 195 条公开 Prompt · 13 条来源核验教程
...
[![案例数量](https://img.shields.io/badge/视频案例-868-d8ff3e?style=flat-square&labelColor=0a0b09)](./CATALOG.md)
[![公开 Prompt](https://img.shields.io/badge/公开_Prompt_原文-195-f5f5ed?style=flat-square&labelColor=0a0b09)](./data/cases.json)
...
[▶ 浏览全部 868 个视频案例](https://h3-field-notes-production.up.railway.app/) · [在 GitHub 查看案例](./CATALOG.md) · [English](./README.md) · [参与贡献](./CONTRIBUTING.md)
...
> **在 2026-08-16 的公开同类库对比中规模最大：** 本库现有 868 个可播放、来源可追溯的 MiniMax H3 视频案例。该次检索中较大的公开案例或 Prompt 图库分别约为 300、222、135、67 和 28 条；只有 Prompt、没有对应视频案例的列表不计入案例库对比。
...
| 你能得到什么 | 对用户的价值 |
| --- | --- |
| **868 个可观看视频案例** | 不读功能列表，直接根据真实输出判断 MiniMax H3 / Hailuo H3 的效果 |
| **时长优先浏览** | 直接查看 ≤5 秒、6–10 秒、11–15 秒或 >15 秒输出，再按内容、风格和场景细分 |
| **一键只看有 Prompt** | 只保留原作者或官方逐字公开完整 Prompt 的案例，且可继续叠加其他筛选 |
...
**当前规模：** 868 个视频案例 · 865 个 X 原帖案例 · 3 个官方复现案例 · 195 条公开 Prompt 原文。
