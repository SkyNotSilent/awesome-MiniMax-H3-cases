...
### 730 个来源可追溯、可站内观看的视频案例 · 57 条公开 Prompt · 13 条来源核验教程
...
[![案例数量](https://img.shields.io/badge/视频案例-730-d8ff3e?style=flat-square&labelColor=0a0b09)](./CATALOG.md)
[![公开 Prompt](https://img.shields.io/badge/公开_Prompt_原文-57-f5f5ed?style=flat-square&labelColor=0a0b09)](./data/cases.json)
...
[▶ 浏览全部 730 个视频案例](https://h3-field-notes-production.up.railway.app/) · [在 GitHub 查看案例](./CATALOG.md) · [English](./README.md) · [参与贡献](./CONTRIBUTING.md)
...
> **在 2026-08-16 的公开同类库对比中规模最大：** 本库现有 730 个可播放、来源可追溯的 MiniMax H3 视频案例。该次检索中较大的公开案例或 Prompt 图库分别约为 300、222、135、67 和 28 条；只有 Prompt、没有对应视频案例的列表不计入案例库对比。
...
| 你能得到什么 | 对用户的价值 |
| --- | --- |
| **730 个可观看视频案例** | 不读功能列表，直接根据真实输出判断 MiniMax H3 / Hailuo H3 的效果 |
...
**当前规模：** 730 个视频案例 · 727 个 X 原帖案例 · 3 个官方复现案例 · 57 条公开 Prompt 原文。
