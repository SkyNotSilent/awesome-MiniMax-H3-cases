...
4. Use the official X embed by default. A downloaded video may be committed or hosted only when the embed is unavailable, redistribution permission is documented, and a maintainer approves the fallback.
