...
6. Host approved videos in project storage, keep the original source link, and add `sourceUrl` whenever a public archive is used to recover unavailable media or Prompt text.
