...
<head>
  ...
  <meta name="description" content="${escapeHtml(item.summary)} MiniMax H3 ${escapeHtml(item.mode)} AI 视频案例、完整提示词与原始来源。" />
...
const sitemapEntries = cases.map((item) => `  <url>
