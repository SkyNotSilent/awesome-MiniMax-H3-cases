...
export const addedPresets = ['all', 'unseen', '7d', '30d']
...
const legacyAddedPresets = { today: 'unseen' }
...
export function parseFilters(params, taxonomy) {
  ...
  const legacy = legacyCollections[params.get('collection')] ?? {}
  ...
  return {
    ...
    added: legacyAddedPresets[rawAdded] ?? pick('added', addedPresets, 'all'),
