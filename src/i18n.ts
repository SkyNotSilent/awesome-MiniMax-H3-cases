...
export const copy = {
  zh: {
    ...
    dialog: {
      ...
      promptExcerptNotice: '参考来源与原帖仅保留了以 ... 结尾的公开 Prompt 节选；本页按归档原文展示，未补写缺失内容。',
  ...
  en: {
    ...
    dialog: {
      ...
      promptExcerptNotice: 'The source and reference source retain only a public Prompt excerpt ending in ...; it is shown verbatim here without completing the missing text.',
