...
export const copy = {
  zh: {
    ...
    catalog: {
      ...
      upToDateTitle: '已是最新。',
      upToDateDescription: '自上次访问后暂无新增；近 7 天收录和完整案例库仍可继续浏览。',
      ...
      storageUnavailableDescription: '当前浏览器无法保存访问记录，“本次新增”暂按今天收录的内容显示。',
      trackingStartsNow: '从本次访问开始记录；本次新增暂按今天收录的内容显示。',
      noUnseenUpdates: '已是最新；下一批内容发布后会在这里显示。',
      storageUnavailableHint: '浏览器存储不可用，本次新增暂按今天收录的内容显示。',
  ...
  en: {
    ...
    catalog: {
      ...
      upToDateDescription: 'Nothing was added since your last visit; the last 7 days and the complete library remain ready to browse.',
      ...
      storageUnavailableDescription: 'This browser cannot save visit history, so “Since last visit” shows today’s additions instead.',
      trackingStartsNow: 'Tracking starts with this visit; until then “Since last visit” shows today’s additions.',
      noUnseenUpdates: 'You are up to date; the next published batch will appear here.',
      storageUnavailableHint: 'Browser storage is unavailable, so “Since last visit” shows today’s additions instead.',
