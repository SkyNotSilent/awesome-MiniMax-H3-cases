...
export const copy = {
  zh: {
    ...
    intro: {
      ...
      caseEyebrow: '01 / 案例规模',
      caseLabel: '可播放视频案例',
      promptLabel: '完整公开 Prompt',
      guideLabel: '核验教程',
      rankEyebrow: '02 / 公开同类库对比',
      rankValue: '#01',
      rankLabel: '已核验对比中规模最大',
      rankFootnote: '2026.08.16 对比快照',
      proofLine: '全网更多真实案例，就在这里',
      ready: '案例界面已就绪',
      skip: '跳过开场',
    },
    catalog: {
  ...
  en: {
    ...
    intro: {
      ...
      promptLabel: 'COMPLETE PUBLIC PROMPTS',
      guideLabel: 'VERIFIED GUIDES',
      rankEyebrow: '02 / PUBLIC LIBRARY COMPARISON',
      rankValue: '#01',
      rankLabel: 'LARGEST IN OUR VERIFIED COMPARISON',
      rankFootnote: 'COMPARISON SNAPSHOT · 2026.08.16',
      proofLine: 'MORE REAL MINIMAX H3 CASES, ALL IN ONE PLACE',
...
export function modelLabel(item: VideoCase, language: Language) {
  ...
  return item.model
    ...
    .replace('（公开来源标注）', ' (public-archive-identified)')
